...
class Userpage extends Component {
  ...
  fechServices() {
    Promise.all([fetch(`http://localhost:8001/api/services/3`)])
      .then(([res1]) => {
...
>>>>>>> 73853329f7937f44ac023e7fab7bd1b68114c88a
    ...
    return (
      <React.Fragment>
        <Navbar bg="primary" variant="dark" className="app__bar">
          ...
          <Nav>
            <button className="delete">
              Emergency Contact: +1 508 445 9343
            </button>
            <button
              className="delete"
              onClick={() => {
        ...
        <div className="posts__container">{postits}</div>
        <Footer />
      </React.Fragment>
    );
  }
