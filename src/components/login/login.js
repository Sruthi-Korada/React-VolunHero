          ...
          <div className="login__card__content">
            ...
            {isLogin ? (
              <div className="login__card__wrap">
                <h2 className="login__card__title">
                  One of the most important things you can do on this earth is
                ...
                <div className="login__card__footer">
                  <button
                    ...
                    className={!isLogin ? "login__card__signup" : ""}
                  >
                    Sign up
                  </button>
                  <button
              ...
              <div className="registration__card__wrap">
                <h2 className="login__card__title text__align__center">
                  One of the most important things you can do on this earth is
                  to let people know they are not alone.
                </h2>
                ...
                <button type="submit" className="login__card__btn button__big">
                  Sign Up
                </button>
                <div className="login__card__footer">
                  <button
